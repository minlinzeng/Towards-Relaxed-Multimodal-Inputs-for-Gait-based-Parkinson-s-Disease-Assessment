...
class pdfeReader():
    ...
    def visualize_pose():
        from data_processing.common import visualize_sequence
...
def main():
    reader = pdfeReader(
        pose_path='data/FoG/predictions',
        lifted_path='data/FoG/lifted',
        sensor_path='data/FoG/IMU',
        label_path='data/FoG/PDFEinfo.xlsx'
    )
    print(f"sensor length is :{reader.sensor_length}")

if __name__ == "__main__":
    main()        
    # video_path = 'data/FoG/lifted'
    # pose_path = 'data/FoG/predictions'
    # sensor_path = 'data/FoG/IMU'
    # label_path = 'data/FoG/PDFEinfo.xlsx'
