...
try:
    from .common import H36M_FULL
except ImportError:  # allows running this file directly from train/data_processing
    from common import H36M_FULL

try:
    import c3d
except ImportError:  # optional for preprocessing only
    c3d = None
...
def read_pd(sequence_path):
    ...
    if c3d is None:
        raise ImportError("c3d is required to read raw .c3d files")
