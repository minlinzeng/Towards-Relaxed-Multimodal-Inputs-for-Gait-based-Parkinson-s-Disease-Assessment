...
from optimizers.losses import LDAMLoss, GCLLoss
...
for seed in 42 43 44 2 3 4; do
  nohup python3 ablation.py \
    ...
    --drw_warmup 10 \
    --seed "$seed" \
    > "logs/turn/mm_alpha0_1/gcl/best/a0.8_s25_m0.1_nm0.1_wu10_b256_50ep_${seed}.out" 2>&1 &
  sleep 0.2
done
